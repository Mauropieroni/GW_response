...
class Detector(ABC):
    ...
    def vertex_positions(self, time_in_years) -> jax.Array:
        return self._vertex_positions(as_time_array(time_in_years))

    @abstractmethod
    def _vertex_positions(self, time_in_years) -> jax.Array:
        pass

    def detector_arms(self, time_in_years) -> jax.Array:
        return self._detector_arms(as_time_array(time_in_years))

    @abstractmethod
    def _detector_arms(self, time_in_years) -> jax.Array:
        pass
