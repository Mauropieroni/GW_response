...
class BasisTransformations:
    ...
    Attributes:
        XYZ_to_AET (jnp.array): A numpy array representing the transformation
            matrix from the XYZ coordinate system to the AET coordinate
            system. The transformation matrix is defined as
            ``[[-1/sqrt(2), 0, 1/sqrt(2)], [1/sqrt(6), -2/sqrt(6),
            1/sqrt(6)], [1/sqrt(3), 1/sqrt(3), 1/sqrt(3)]]``.
